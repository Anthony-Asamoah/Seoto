...
from domains.company.hr.staff.admin.staff import (
    MemberAdmin, AssignmentInline, AssignmentInlineForm, AssignmentInlineFormSet, PositionAdmin,
)
from domains.company.hr.staff.models import Assignment, Member, Position

from .helpers import User, make_member, make_assignment
