...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS('=' * 60))
        self.stdout.write('1. Both keys are single-line base64url — safe for .env / PythonAnywhere.')
        ...
        self.stdout.write('4. Update local .env and PythonAnywhere environment variables.')
